const Contact = () => {
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 text-raisin_black-500">
        <h1 className="text-3xl font-bold mb-6 text-razzmatazz-500">Contact Mandora</h1>
  
        <p className="mb-6">
          Interested in booking a one-on-one lesson or commissioning a piece? Please send a message below!
          You can also email her directly at{" "}
          <a href="mailto:mypajntaub@gmail.com" className="text-risd_blue-500 underline">
